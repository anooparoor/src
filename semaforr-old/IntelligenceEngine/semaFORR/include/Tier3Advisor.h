...
class Tier3Advisor { 
 ...
 public:
  ...
  Tier3Advisor(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool isActive = true); 
    ...
    static Tier3Advisor* makeAdvisor(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool isActive);
    ...
    double get_weight() { return advisorWeight.back();}  
    void set_weight(double weight) {advisorWeight.push_back(weight);} 
    void reset_weight(double weight) {advisorWeight[advisorWeight.size() - 1] = weight ;} 
    vector <double> get_weight_history() { return advisorWeight;}
...
class Tier3Greedy : public Tier3Advisor{
  ...
  Tier3Greedy (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
...
class Tier3GreedyRotation : public Tier3Advisor{
  public:
  // this is constructor for greedy advisor
  Tier3GreedyRotation (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
  Tier3GreedyRotation();
  // Destructor have to be declared for non-virtual classes, virtual; reasons stated in the parent class
...
class Tier3ExitFinderLinear : public Tier3Advisor{
  ...
  Tier3ExitFinderLinear (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
...
class Tier3ExitFinderRotation : public Tier3Advisor{
  public:
  // this is constructor for exitfinder advisor
  Tier3ExitFinderRotation (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
...
class Tier3RegionFinderLinear : public Tier3Advisor{
  ...
  Tier3RegionFinderLinear (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
...
class Tier3RegionFinderRotation : public Tier3Advisor{
  ...
  Tier3RegionFinderRotation (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
...
class Tier3AvoidRobot : public Tier3Advisor{
  public:
  // this is constructor for greedy advisor
  Tier3AvoidRobot (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
  Tier3AvoidRobot();
  // Destructor have to be declared for non-virtual classes, virtual; reasons stated in the parent class
...
class Tier3AvoidRobotRotation : public Tier3Advisor{
  public:
  // this is constructor for greedy advisor
  Tier3AvoidRobotRotation (Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Here is dummy default constructor
...
class Tier3AvoidObstacle : public Tier3Advisor{
 public:
  Tier3AvoidObstacle(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Default constructor
  Tier3AvoidObstacle();
...
class Tier3AvoidObstacleRotation : public Tier3Advisor{
 public:
  Tier3AvoidObstacleRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true); 
  // Default constructor
...
class Tier3CloseIn : public Tier3Advisor{
 public:
  Tier3CloseIn(Beliefs *beliefs, string name, string description, vector<double> weight, double * magic_init, bool is_active = true); 
  // Default constructor
  Tier3CloseIn();
...
class Tier3CloseInRotation : public Tier3Advisor{
 public:
  Tier3CloseInRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double * magic_init, bool is_active = true); 
  // Default constructor
...
class Tier3BigStep : public Tier3Advisor{
 public:
  Tier3BigStep(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3BigStepRotation : public Tier3Advisor{
 public:
  Tier3BigStepRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3GoAroundRotation : public Tier3Advisor{
 public:
  Tier3GoAroundRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3AvoidLeaf : public Tier3Advisor{
 public:
  Tier3AvoidLeaf(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3AvoidLeafRotation : public Tier3Advisor{
 public:
  Tier3AvoidLeafRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3Explorer : public Tier3Advisor{
 public:
  Tier3Explorer(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3ExplorerRotation : public Tier3Advisor{
 public:
  Tier3ExplorerRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3BaseLine : public Tier3Advisor{
 public:
  Tier3BaseLine(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3BaseLineRotation : public Tier3Advisor{
 public:
  Tier3BaseLineRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3GateFinderLinear : public Tier3Advisor{
 public: 
  Tier3GateFinderLinear(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3GateFinderRotation : public Tier3Advisor{
 public: 
  Tier3GateFinderRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3PortalHopperLinear : public Tier3Advisor{
 public: 
  Tier3PortalHopperLinear(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3PortalHopperRotation : public Tier3Advisor{
 public: 
  Tier3PortalHopperRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3WaypointFinderLinear : public Tier3Advisor{
 public: 
  Tier3WaypointFinderLinear(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3WaypointFinderRotation : public Tier3Advisor{
 public: 
  Tier3WaypointFinderRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3TrailFinderLinear : public Tier3Advisor{
 public: 
  Tier3TrailFinderLinear(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
...
class Tier3TrailFinderRotation : public Tier3Advisor{
 public: 
  Tier3TrailFinderRotation(Beliefs *beliefs, string name, string description, vector<double> weight, double *magic_init, bool is_active = true);
